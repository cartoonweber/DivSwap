...
export default function farms() {
    const imgs = [["community.svg", "blackbusd.svg"], ["community.svg", "blackwbnb.svg"], ["wbnb.svg", "blackbusd.svg"], ["t.svg", "blackwbnb.svg"],
    ...
    const titles = ["NOVA-BUSD LP", "NOVA-BNB LP", "BNB-BUSD LP", "USDT-BNB LP", "MATIC-BNB LP", "CAKE-BNB LP", "BTCB-BNB LP",
    ...
    const xs = ["8X", "8X", "2X", "2X", "1.5X", "1.5X", "1X", "1X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.5X", "0.2X", "0.2X"];
    const values = [["269.71%", "sNOVA", "$280,477.45"], ["262.16%", "sNOVA", "$288,550.56"], ["67.13%", "NOVA", "$281,536.49"], ["113.87%", "NOVA", "$165,966.87"],
